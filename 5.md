...
#### **Removing elements**:
- `remove()`: Removes the first occurrence of an element. it uses the values not the indexing
  ```python
...
### pop() can store the removed value
```python
numbers = [10, 20, 30, 40]
...
1. Removes the element
2. Gives you the removed element
